...
public class ConversationManager implements Startable, ComponentEventListener {
    ...
    {
        CachedPreparedStatement statement = null;
        ...
        try
        {
            ...
            statement = new CachedPreparedStatement();
            statement.setSQL("DELETE FROM ofKeywords");
            preparedStatement = DbConnectionManager.createScrollablePreparedStatement(connection, statement.getSQL());
            statement.setParams(preparedStatement);
        ...
        try
        {
            ...
            for (String entry : entries)
            {
                ...
                {
                    statement = new CachedPreparedStatement();
                    statement.addString(entry);
                    statement.setSQL("INSERT INTO ofKeywords (keyword) VALUES (?)");
    ...
    public String fetchKeywords()
    {
        ...
        try
        {
            ...
            statement = new CachedPreparedStatement();
            statement.setSQL("SELECT keyword FROM ofKeywords");
            connection = DbConnectionManager.getConnection();
            preparedStatement = DbConnectionManager.createScrollablePreparedStatement(connection, statement.getSQL());
            statement.setParams(preparedStatement);
            ...
            {
                keywordBuilder.append(resultSet.getString(1));
            ...
            {
                keywordBuilder.deleteCharAt(keywordBuilder.length()-1);
            }
        }
        catch (SQLException ex)
        {
