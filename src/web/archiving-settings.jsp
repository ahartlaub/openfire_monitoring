...
<% // Get parameters
    ...
    if (update) {
        ...
        {
            errors.put("txtKeywords", "");
            errorMessage = "Keywords must be provided.";
        }
        ...
        if (errors.size() == 0) {
            ...
            conversationManager.saveKeywords(txtKeywords);
...
<form action="archiving-settings.jsp" method="post">
    <table class="settingsTable" cellpadding="3" cellspacing="0" border="0" width="90%">
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <label class="jive-label">Keywords:</label><br>
                    The keywords used to flag conversations as suspect.<br><br>
                </td>
                <td>
                    <textarea name="txtKeywords" cols="35" rows="7" wrap="virtual"><%= conversationManager.fetchKeywords()%></textarea>
                </td>
                <td>
                </td>
            </tr>
